...
<button
    ...
    on:click|stopPropagation={() => (settingsVisible = !settingsVisible)}
>
    <svg height="24" viewBox="0 -960 960 960" width="24" fill="white">
        <path
...
<main class:settings-open={settingsVisible}>
    <slot />
</main>

<Settings bind:settingsVisible />
